...
@app.cell
def __(Path):
    base_path = Path('/sc/arion/projects/comppath_SAIF/slide_experiments/skin/')
...
def __(Path, demographic_groups, entropy, kurtosis, np, pickle):
    def load_attention_scores(exp_version):
        ...
        base_path = Path(f'/sc/arion/projects/comppath_SAIF/slide_experiments/skin/{exp_version}')
